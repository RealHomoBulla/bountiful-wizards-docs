...
⚖️ Оно **публичное** (решение владельца 25.08). Для самого сайта оно не нужно — он и так всё видит.
...
🔴 **У `sync_kubejs.py` и `sync_client.py` ловушка ещё жива.** Не спрашивай у них справку: любой
нераспознанный аргумент они понимают как «делай». Строка `SYNC-HELP-IS-A-WRITE` в `TODO.md`.
